A notebook which reads a TensorFlow neural network object and converts it to a gdx object for the weights and biases of the ANN to be read when embedded in the optimisation models.
